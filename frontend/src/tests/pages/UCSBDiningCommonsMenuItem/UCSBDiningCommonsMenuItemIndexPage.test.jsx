...
describe("UCSBDiningCommonsMenuItemsIndexPage tests", () => {
  ...
  test("renders three UCSBDiningCommonsMenuItemTable correctly for regular user", async () => {
    setupUserOnly();
    axiosMock
    ...
    const name = screen.getByText("Fish");
    expect(name).toBeInTheDocument();

    const station = screen.getByText("Bakery");
