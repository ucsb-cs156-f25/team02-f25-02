  ...
  describe("tests where backend is working normally", () => {
    beforeEach(() => {
      ...
      axiosMock.onPut("/api/helprequests").reply(200, {
        id: 17,
        requesterEmail: "aaaaaaa25@ucsb.edu",
        teamId: "f26-2pm-2",
    ...
    test("Is populated with the data provided", async () => {
      ...
      expect(requesterEmailField).toHaveValue("aaaaaaa@ucsb.edu");

      expect(teamIdField).toBeInTheDocument();
      expect(teamIdField).toHaveValue("f25-2pm-2");
      ...
      fireEvent.change(requesterEmailField, {
        target: { value: "aaaaaaa25@ucsb.edu" },
      });

      fireEvent.change(teamIdField, {
        target: { value: "f26-2pm-2" },
      });
      ...
      fireEvent.change(requestTimeField, {
        target: { value: "2025-10-02T16:30" },
      });

      fireEvent.change(explanationField, {
        target: { value: "Need help with Swagger-ui 25edits" },
      });
      ...
      expect(mockToast).toBeCalledWith(
        "HelpRequest Updated - id: 17 requesterEmail: aaaaaaa25@ucsb.edu",
      );
