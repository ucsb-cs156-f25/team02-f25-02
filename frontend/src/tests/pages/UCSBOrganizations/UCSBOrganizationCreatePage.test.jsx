...
describe("UCSBOrganizationCreatePage tests", () => {
  ...
  test("inactive='true' is sent as boolean true", async () => {
    const queryClient = new QueryClient();

    // the backend echoes what it received (status doesn't matter for Stryker)
    ...
    // IMPORTANT: drive the string "true" path
