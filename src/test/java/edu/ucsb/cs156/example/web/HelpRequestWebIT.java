...
public class HelpRequestWebIT extends WebTestCase {
  ...
  public void admin_user_can_create_edit_delete_help_request() throws Exception {
    ...
    page.getByTestId("HelpRequestForm-requesterEmail").fill("ealemus@ucsb.edu");
    page.getByTestId("HelpRequestForm-teamId").fill("f25-5pm-3");
    ...
    page.getByTestId("HelpRequestForm-explanation").fill("Need help with HelpRequestController");
