...
public class MenuItemReviewIT {
  ...
  public void an_admin_user_can_post_a_new_menu_item_review() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/menuitemreview/post?itemId=27&reviewerEmail=cgaucho@ucsb.edu&stars=5&dateReviewed=2022-01-02T12:00:00&comments=Great burrito, best I've ever had!")
                    .with(csrf()))
